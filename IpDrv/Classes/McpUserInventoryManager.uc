 ...
 */
function PurchaseItem(string McpId, string SaveSlotId, string GlobalItemId, array<string> PurchaseItemIds, int Quantity, int StoreVersion)
{
	...
	if (ExistingIndex == INDEX_NONE)
	{
		...
		if (Request != None)
		{
			...
			if (ExpectedResultItems.Length > 0)
			{
				...
				expectedResultsItemsJson $= " ]";
				Url $= "&expectedSaleValue=" $ expectedResultsItemsJson;
			}
