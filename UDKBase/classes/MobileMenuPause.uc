...
defaultproperties
{
	...
	Begin Object Class=MobileMenuButton Name=BenchmarkButton
		...
		ImagesUVs(0)=(bCustomCoords=true,U=3,V=0,UL=308,VL=47)
		ImagesUVs(1)=(bCustomCoords=true,U=3,V=59,UL=308,VL=47)
	End Object
	...
	Begin Object Class=MobileMenuButton Name=SettingsButton
		...
		Images(0)=Texture2D'CastleUIExt.T_CastleMenu2Ext'
		Images(1)=Texture2D'CastleUIExt.T_CastleMenu2Ext'
		ImagesUVs(0)=(bCustomCoords=true,U=370,V=0,UL=140,VL=62)
		ImagesUVs(1)=(bCustomCoords=true,U=370,V=67,UL=140,VL=62)
	End Object
