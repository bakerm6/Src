...
{
	local CastlePC PC;
	local int fps, ScreenCenterX, BGTop, BGWidth, BGHeight;
	...
	BGTop = PC.ViewportSize.Y * 0.42;
	BGWidth = PC.ViewportSize.Y * 0.9;
	BGHeight = PC.ViewportSize.Y * 0.25;
	...
	Canvas.SetPos( ScreenCenterX - StringWidth/2 * TextScale, BGTop + BGHeight * 0.5 );
...
defaultproperties
{
	...
	BenchmarkBackgroundUVs=(U=26,V=180,UL=462,VL=272)
 }
